...
then
  exec
xrandr --output HDMI1 --off --output LVDS1 --mode 1366x768 --pos 1440x132 --rotate normal --output VIRTUAL1 --off --output DP1 --off --output VGA1 --mode 1440x900 --pos 0x0 --rotate normal
  exit
else
